...
st.title("Hi, This is Chatbot Nithesh :sunglasses:") # **Modify this based on the title you want in want
...
input_text = st.chat_input("Chat with Nithesh Sivakumar's Bot here") # **display a chat input box
if input_text: 
